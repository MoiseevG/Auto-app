...
export default function ShiftLogsPage() {
  ...
  return (
    <div style={{ padding: "24px", maxWidth: "1200px", margin: "0 auto" }}>
      <h1 style={{ fontSize: "2rem", color: "white", marginBottom: "24px" }}>
        📋 Логи смен
      </h1>
          ...
          <table style={{
            ...
            <thead>
              <tr style={{ background: "#1e40af" }}>
                <th style={{ padding: "16px", textAlign: "left", color: "white", fontWeight: "bold" }}>
                  Оператор
                </th>
                <th style={{ padding: "16px", textAlign: "left", color: "white", fontWeight: "bold" }}>
                  Действие
                ...
                <th style={{ padding: "16px", textAlign: "center", color: "white", fontWeight: "bold" }}>
                  Длительность
                </th>
              </tr>
            </thead>
            <tbody>
              {filteredLogs.map((log, idx) => (
                <tr key={log.id} style={{
                  ...
                  <td style={{ padding: "16px", color: "#6b7280", fontSize: "0.9rem" }}>
                    {formatTime(log.shift_start)}
                  </td>
                  <td style={{ padding: "16px", color: "#6b7280", fontSize: "0.9rem" }}>
                    {log.shift_end ? formatTime(log.shift_end) : "-"}
                  </td>
                  <td style={{ padding: "16px", textAlign: "center", fontWeight: "bold", color: "#1f2937" }}>
